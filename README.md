**Note** This is a fork of the BattleSnake Official Node Starter. I've modified the instructions a bit to make it easy for you to get signed in. Good luck!
...
* [Battlesnake Account](https://play.battlesnake.com) - Sign Up with GitHub
* [Repl.it Account](https://repl.it)

## Running Your Battlesnake on [Repl.it](https://repl.it)

1. Click `Run ▶️` at the top of the screen. You should see Express (and any other dependencies) being installed. Once installation is complete, your Battlesnake server will start and you should see the following:

    ```
    Battlesnake Server listening at http://127.0.0.1:3000
    ```

1. Above the terminal window you'll see the live output from your Battlesnake server, including its URL. That URL will be the URL used to create your Battlesnake in the next step. If you visit that URL in your browser, you should see text similar to this:
...
1. Sign in to [play.battlesnake.com](https://play.battlesnake.com/login/) with GitHub.
